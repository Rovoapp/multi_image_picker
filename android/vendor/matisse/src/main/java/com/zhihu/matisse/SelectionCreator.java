...
public final class SelectionCreator {
    ...
    public SelectionCreator menuItem(String menu) {
        mSelectionSpec.menuItem = menu;
        return this;
    }

    public SelectionCreator maxCountMessage(String message) {
        mSelectionSpec.maxCountMessage = message;
        return this;
    }
