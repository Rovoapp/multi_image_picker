...
import com.zhihu.matisse.internal.utils.TypefaceSpan;
...
public class MatisseActivity extends AppCompatActivity implements
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        SpannableString spannableString = new SpannableString(mSpec.menuItem);
        spannableString.setSpan(new ForegroundColorSpan(ContextCompat.getColor(this, R.color.turquoiseBlue)), 0, spannableString.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        spannableString.setSpan(new TypefaceSpan(this, TypefaceProvider.Style.BOLD.getFullName()), 0, spannableString.length(), 0);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        MatisseActivityPermissionsDispatcher.onRequestPermissionsResult(this, requestCode, grantResults);
    }
    ...
    @Override
    public void capture() {
        MatisseActivityPermissionsDispatcher.captureIntentWithPermissionCheck(this);
    }
