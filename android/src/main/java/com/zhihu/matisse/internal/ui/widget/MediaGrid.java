...
public class MediaGrid extends SquareFrameLayout implements View.OnClickListener {
    ...
    private RVTextView mCheckCount;
    ...
    private void init(Context context) {
        ...
        mCheckLayout = findViewById(R.id.check_layout);
        mCheckCount = findViewById(R.id.check_count);
    ...
    public void onClick(View v) {
        if (mListener != null) {
            if (v == mThumbnail) {
                mListener.onCheckViewClicked(mCheckLayout, mCheckCount, mMedia, mPreBindInfo.mViewHolder);
            }
        }
    }
    ...
    public void setCheckedNum(int checkedNum) {
        ...
        mCheckLayout.setVisibility(CheckView.UNCHECKED == checkedNum ? View.GONE : View.VISIBLE);
        mCheckCount.setText(String.valueOf(checkedNum));
    }

    public void setChecked(boolean checked) {
        mCheckView.setChecked(checked);
        mCheckLayout.setVisibility(checked ? View.VISIBLE : View.GONE);
    }
    ...
    public interface OnMediaGridClickListener {
        ...
        void onCheckViewClicked(FrameLayout checkLayout, RVTextView checkCount, Item item, RecyclerView.ViewHolder holder);
    }
